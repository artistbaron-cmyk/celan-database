...
- Apply the Ohnoshan Metaphor Test before recommending polysemy: a new sense must arise naturally from Celan's established semantic relationships, Ohnoshan lived experience, or an attested internal grammatical development. An English word carrying both meanings is not sufficient evidence. Classify the result as a displayed sense, ordinary usage, idiom, better compound, or rejection.
