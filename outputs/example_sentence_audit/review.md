...
September 24 update: all 135 submitted instructions applied locally, including the five follow-up corrections. [Read every applied change](round2_applied.md). No decisions from this batch are waiting on the user.
